      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-8 w-8" src="https://photos.google.com/photo/AF1QipPgPF-WrGYJv-IqEPzYCMzC2cCyxD-uvj0BfsKk" alt="Your Company">
          </div>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            @guest
              {{-- Login  --}}
              <a href="/login" class="text-white hover:bg-blue-600 px-3 py-2 rounded-lg ">Log In</a>

              {{-- Registration  --}}
              <a href="/register" class="text-white hover:bg-blue-600 px-3 py-2 rounded-lg ">Registration</a>
            @endguest
          </div>
        </div>
